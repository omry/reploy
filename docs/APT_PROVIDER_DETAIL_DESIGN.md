...
source-relative subtrees. This extension is not present in the current
implementation baseline, whose strict decoder rejects `exclude`; once the
delivery tracked in the Blueprint implementation plan lands, Reploy applies
