...
filesystem identity so procfs, sysfs, cgroup hierarchies, devpts, and legacy
...
rejects it as well. On macOS, native devfs and procfs sources are likewise rejected.
