...
observed canonical ABI, and `abi3` requires CPython at or above the tag's
encoded release. Any other Python/ABI form fails closed before acquisition.
...
stable-ABI tags, and a nonmatching implementation or ABI. Platform fixtures
