...
Remote review capacity is a shared, exhaustible resource, so `PTD-01` through
`PTD-11` are constructed before any of them is reviewed remotely. Construction
and review are separate phases with separate evidence.
