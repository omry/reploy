...
ones conflict; installation destinations conflict catalog-wide and not only
within one support tuple; validation acquires no bytes.
...
closure cannot alias loaded catalog state.
