...
PTD-23.1.1 through PTD-23.1.8. PTD-23.2 and PTD-23.3 retain their identities
and scopes, with PTD-23.2 depending on the completed PTD-23.1.8 handoff. This
is a delivery-boundary correction only and does not change the accepted
portable-tool design, support envelope, schema-v1 artifact cardinality, or
Python provider ownership.
...
preserves the existing PTD-23.1 contract and introduces no compatibility
adapter between child heads.

Acceptance: every responsibility and fixture previously owned by PTD-23.1 is
owned exactly once by a child below; every child compiles, passes its focused
checks, and maps one-to-one to a current-head-approved pull request. PTD-23.1
closes only after PTD-23.1.1 through PTD-23.1.8 do.
