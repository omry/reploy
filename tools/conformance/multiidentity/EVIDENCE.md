...
Status: passed on 2026-08-14 from 21:12:49 through 21:14:52 UTC.
...
- Probe source SHA-256: `25477af6eda4d5571bd361fc32a62ecbf62780fdca10877a0ffcdfbbca3282ef`
- Host: Ubuntu 24.04 on Linux 6.6.114.1 WSL2, x86_64
- Rootless Podman: 4.9.3, local socket
- OCI runtime: crun 1.14.1
- Delegation: UID and GID range `100000:65536`; the harness also checked the
  mapped IDs against local NSS principals and every other subordinate
  delegation present on the host
...
- an opted-in supervisor capability mask of exactly `0x1c0`, a separate
  default-capability run with every capability set empty, and denial of the
  profile's capability-conditioned `bpf` syscall;
