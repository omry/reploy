...
func (catalog *CatalogV1) SelectReleaseCandidatesV1(request ToolRequestV1, observed TargetIdentityV1,
	...
	if request.Version != "" && !validRecordSegmentV1(request.Version) {
		return nil, fmt.Errorf("tool version %q is invalid", request.Version)
	}
	if request.Revision != "" {
...
// matchesRequestedVersionV1 reports whether a release answers to a coordinate,
// by exact version or by one of its advertised aliases.
