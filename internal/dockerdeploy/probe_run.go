...
func openImageValidationSessionWithCreate(
	...
	return openImageValidationSessionWithCreateContext(ctx, descriptor, workspace, aptWorkspace, create, false)
}
...
func openImageValidationSessionWithCreateBounded(
	...
	return openImageValidationSessionWithCreateContext(ctx, descriptor, workspace, aptWorkspace, create, true)
}
...
func openImageValidationSessionWithCreateContext(
	...
	if err := ctx.Err(); err != nil {
		cleanupErr := removeImageValidationContainer(createContext, containerName, runDocker)
