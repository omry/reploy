...
// itself. The bulk copy uses a fixed symbolic COPY mode and selected
// executable overlays use 0555.
// BuildKit's symbolic COPY chmod can leave nested directories non-traversable,
// while Docker creates destination roots with 0755. One network-disabled,
// recursive chmod seals directories and executable files to 0555 and ordinary
// files to 0444 after all copies, independent of host mode reporting.
...
// Dockerfile produces only fixed COPY, network-disabled tree-mode sealing, and
