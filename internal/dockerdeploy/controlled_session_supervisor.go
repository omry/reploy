...
func RunControlledSessionV1(
	...
	result, runErr := runControlledSessionV1(ctx, plan, options, controlledSessionSupervisorBackendV1{
		...
		recordControllerOwnership: func(controllerID string) error {
			return persistOwnership(controllerID, "")
		},
...
func controlledSessionPreparationCanCompleteV1(cleaned bool, ownershipRecorded bool, released bool, channelCleanupVerified bool) bool {
	return cleaned && (!ownershipRecorded || released || channelCleanupVerified)
}
