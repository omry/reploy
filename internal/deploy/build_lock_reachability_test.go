...
func portableToolReachabilityLockV1(t *testing.T, build *BuildLockV1, artifact providerstore.ArtifactDescriptor) *providers.PortableToolLockV1 {
	...
	baseNode := providers.NodeSpec{
		ID: "base", Provider: blueprint.ComponentTypeBase, Components: []string{"base"},
		Request:            providers.CanonicalProviderRequest{Schema: "base-provider-request-v1", Provider: blueprint.ComponentTypeBase, Value: canonical.Object{}},
		...
		Requirements: providers.RequirementDeclaration{
			...
			ProviderData: providers.CanonicalProviderData{Schema: "base-requirements-v1", Value: canonical.Object{}},
		},
	}
