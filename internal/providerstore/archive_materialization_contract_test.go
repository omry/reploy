...
func TestArchiveMaterializationContractNormalizesPaths(t *testing.T) {
	tests := []struct {
		...
		{name: "path-byte-limit", value: strings.Repeat("a", CoreMaxArchivePathBytes+1), wantErr: "exceeds"},
