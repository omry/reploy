...
func RunControllerBrokerV1(ctx context.Context, options ControllerBrokerOptionsV1) (resultErr error) {
	...
	return runClaimedControllerBrokerV1(ctx, session, terminal, streamReader, streamWriter, opened.Authorization.Operations, controllerRequestWriteTimeoutV1, terminalWriteTimeout)
}
