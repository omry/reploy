...
func ValidateResultV1(result ResultV1) error {
	...
	if result.Cause == CauseWorkloadExitV1 && result.WorkloadStatus.Kind == ProcessStatusUnknownV1 {
		return fmt.Errorf("workload-exit termination requires a known workload status")
	}
