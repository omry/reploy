...
func TestRequestV1RoundTripsBinarySafeFrames(t *testing.T) {
	requests := []RequestV1{
		...
		{Kind: RequestOpenEndpointV1, RequestID: 17, EndpointID: "browser"},
...
func TestEventV1RoundTripsStrictTypedFrames(t *testing.T) {
	...
	events := []EventV1{
		...
		{Kind: EventEndpointOpenedV1, EndpointOpened: &EndpointOpenedV1{RequestID: 17, EndpointID: "browser", StreamID: 23}},
		{Kind: EventEndpointOpenFailedV1, EndpointOpenFailed: &EndpointOpenFailedV1{RequestID: 18, EndpointID: "browser", Code: "resource-exhausted", Message: "endpoint stream limit reached"}},
		{Kind: EventEndpointClosedV1, EndpointClosed: &EndpointClosedV1{EndpointID: "browser", StreamID: 23, Reason: "session terminating"}},
...
func TestFrameV1RejectsBadMagicVersionTruncationAndUnknownJSON(t *testing.T) {
	...
	nestedCaseVariant := []byte(`{"cause":"workload-exit","workload_status":{"Kind":"exited","code":0},"controller_finalization_status":{"kind":"completed"},"cleanup_status":{"kind":"succeeded"},"recovery_action":"none"}`)
	framed.Reset()
...
func TestValidateRequestV1RejectsAmbiguousUnionPayloads(t *testing.T) {
	tests := []RequestV1{
		...
		{Kind: RequestOpenEndpointV1, RequestID: 17, EndpointID: "../other"},
...
func TestValidateEventV1RejectsInvalidEndpointOutcomes(t *testing.T) {
	tests := []EventV1{
		{Kind: EventEndpointOpenedV1, EndpointOpened: &EndpointOpenedV1{EndpointID: "browser", StreamID: 1}},
		{Kind: EventEndpointOpenedV1, EndpointOpened: &EndpointOpenedV1{RequestID: 1, EndpointID: "browser"}},
		{Kind: EventEndpointOpenFailedV1, EndpointOpenFailed: &EndpointOpenFailedV1{RequestID: 1, EndpointID: "browser", Code: "resource-exhausted"}},
		{Kind: EventEndpointClosedV1, EndpointClosed: &EndpointClosedV1{EndpointID: "browser", Reason: "closed"}},
		{Kind: EventEndpointOpenedV1, EndpointOpened: &EndpointOpenedV1{RequestID: 1, EndpointID: "browser", StreamID: 1}, Diagnostic: &DiagnosticV1{Code: "extra", Message: "extra payload"}},
	}
