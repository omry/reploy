...
func TestEventV1RoundTripsStrictTypedFrames(t *testing.T) {
	...
	events := []EventV1{
		...
		{Kind: EventApplicationExitV1, ApplicationExit: &ApplicationExitV1{Status: ProcessStatusV1{Kind: ProcessStatusExitedV1, Code: &code}}},
		{Kind: EventTerminatingV1, Terminating: &TerminatingV1{Cause: CauseApplicationExitV1}},
		...
		{Kind: EventTerminatedV1, Terminated: &ResultV1{
			Cause: CauseApplicationExitV1, ApplicationStatus: ProcessStatusV1{Kind: ProcessStatusExitedV1, Code: &code},
...
func TestFrameV1RejectsBadMagicVersionTruncationAndUnknownJSON(t *testing.T) {
	...
	nestedCaseVariant := []byte(`{"cause":"application-exit","application_status":{"Kind":"exited","code":0},"controller_status":{"kind":"completed"},"cleanup_status":{"kind":"succeeded"},"recovery_action":"none"}`)
	framed.Reset()
