...
func run(args []string, stderr io.Writer) int {
	...
	controllerLinuxAMD64 := flags.String("controller-linux-amd64", "", "linux/amd64 controller Reploy")
	controllerLinuxARM64 := flags.String("controller-linux-arm64", "", "linux/arm64 controller Reploy")
	...
	if flags.NArg() != 0 || *executable == "" || *linuxAMD64 == "" || *linuxARMv7 == "" || *linuxARM64 == "" || *controllerLinuxAMD64 == "" || *controllerLinuxARM64 == "" || *version == "" {
		_, _ = fmt.Fprintln(stderr, "reploy-probe-pack requires --executable, --linux-amd64, --linux-arm-v7, --linux-arm64, --controller-linux-amd64, --controller-linux-arm64, and --version")
		return 2
	}
	...
	controllers := []probearchive.ControllerInput{
		{Platform: "linux/amd64", Path: *controllerLinuxAMD64},
		{Platform: "linux/arm64", Path: *controllerLinuxARM64},
	}
	release := probearchive.ReleaseV1{
		Version: *version, BuildCommit: *buildCommit,
		BuildDirty: *buildDirty, BuildTimestamp: *buildTimestamp,
	}
	if err := probearchive.Append(*executable, release, inputs, controllers); err != nil {
