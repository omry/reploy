...
func normalizeWheelVersionSpecifiers(value string) (string, error) {
	...
	for index, part := range parts {
		...
		if operator == "===" {
			// Arbitrary equality is case-insensitive string matching; do not
			// normalize its release numbers, aliases, or optional v prefix.
			versionText = strings.ToLower(versionText)
		} else {
