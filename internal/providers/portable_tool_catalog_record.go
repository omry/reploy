...
type portableToolCatalogExportV1 struct {
	Name string `json:"name"`
	Path string `json:"path"`
}

type portableToolCatalogBindingContractV1 struct {
	...
	CLI               portableToolCatalogExportV1             `json:"cli"`
}
...
func ValidatePortableToolCatalogRecordV1(record CanonicalProviderData) error {
	...
	case portableToolBindingContractSchemaV1:
		return validatePortableToolCatalogBindingContractV1(record.Value)
...
func validatePortableToolCatalogBindingContractV1(value canonical.Object) error {
	const schema = portableToolBindingContractSchemaV1
	...
	for _, version := range record.SupportedPython {
		if err := validatePortableToolCatalogInterpreterVersionV1(version); err != nil {
...
func validatePortableToolCatalogInterpreterVersionV1(value string) error {
