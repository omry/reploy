...
const (
	...
	BindingContractSchemaV1      = "portable-tool-python-binding-v1"
	BindingArtifactSchemaV1      = "portable-tool-python-wheel-artifact-v1"
...
// The unexported marker prevents consumers from extending the versioned
// schema set independently.
type RecordV1 interface {
...
type ReleaseContractV1 struct {
	...
	CompatibilityConstraints []string           `json:"compatibility_constraints"`
}
...
type SelectionCombinationV1 map[string][]string
